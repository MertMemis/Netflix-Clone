...
export default function Row({ title, fetchUrl }) {
  ...
  return (
    <div className="pl-[70px] overflow-hidden relative group">
      <h2 className="text-2xl mt-8 mb-3">{title}</h2>

      <div className="absolute z-10 flex w-full h-[130px] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <button
      ...
      <div
        className="flex transition-transform duration-1000 ease-in-out group"
